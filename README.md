...
Some examples of how Groovy has improved the (readability of) the code are:
 ...
 -  In [`BrowseCoursesSteps.groovy`](src/test/groovy/stepdefinitions/BrowseCoursesSteps.groovy),
 -  In [`BrowseSoftwareTestingSteps.groovy`](src/test/groovy/stepdefinitions/BrowseSoftwareTestingSteps.groovy),
 -  In the package [`pageObjects`](src/main/groovy/pageObjects),
 -
